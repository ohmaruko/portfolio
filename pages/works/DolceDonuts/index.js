            ...
            <Box content={
              <div>
                ...
                <div className={styles.btn}>
                  <Link href='https://www.figma.com/proto/l18aumka9I3yuIv8W5JcGA/DolceDonuts---SET-H?type=design&t=HifTad7UBqVbb5vI-1&scaling=scale-down-width&page-id=0%3A1&node-id=1-16&starting-point-node-id=1%3A16&mode=design' target='_blank'>👉 Website Mockup</Link>
                  <Link href='https://dolcedonuts.vercel.app/' target='_blank'>👉 Coded Website (ongoing)</Link>
                  <Link href='https://github.com/Crystalhtc/dolcedonuts' target='_blank' className={styles.githubLogo}>
