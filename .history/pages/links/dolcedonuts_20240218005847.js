        ...
        <main className={styles.donuts}>
          <Box content={
            <div>
              ...
              <h2>What's next</h2>
              <p>In this project, we only developed the design of website and it is not fully funcional. For a next project, I would like to complete from designing to developenin</p>
            </div>
          }/>
        </main>
