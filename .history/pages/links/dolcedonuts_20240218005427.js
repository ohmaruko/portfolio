        ...
        <main className={styles.donuts}>
          <Box content={
            <div>
              ...
              <p>Tools: Figma</p>
              <h2>Summary</h2>
              <p>We designed a website for a donut cafe. As students, we envisioned a cafe as an ideal place to study.  After brainstorming and ensuring we were aligned in our vision, we crafted a style guide, created wireframes, developed high-fidelity designs, and built prototypes.</p>
              <h2>What I learn</h2>
              <h2>What's next</h2>
            </div>
          }/>
