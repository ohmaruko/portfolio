        ...
        <main className={styles.donuts}>
          <Box content={
            <div>
              ...
              <p>Tools: Figma</p>
              <h2>Summary</h2>
              <p>We designed a website mockup for a donut cafe. After brainstorming and ensuring we were aligned with our vision, we created a style guide, created wireframes and high-fidelity designs.</p>
              <h2>What I learn</h2>
              <p>I learned a basic workflow for designing interface and usage of Figma.</p>
              <h2>What's next</h2>
              <p>In this project, we only developed the design of website and it is not fully funcional. 
                For a next project, I would like to complete from designing to coding it out.</p>
            </div>
          }/>
        </main>
