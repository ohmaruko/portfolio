          ...
          <Box content={
            <div>
              ...
              <div className={styles.styleGuide}>
                ...
                <Image src='/images/dolceFont2.png' alt='styleguide font' width={280} height={168}/>
                <Image src='/images/dolceColour.png' alt='styleguide font' width={280} height={168}/>
                <Image src='/images/dolceButton.png' alt='styleguide font' width={280} height={168}/>
                <Image src='/images/dolceIdeas.png' alt='styleguide font' width={280} height={168}/>
                <Image src='/images/dolceMockup.png' alt='styleguide font' width={280} height={168}/>
              </div>
              <h2>Mock-up</h2>
              <p>
                <Link href="https://www.figma.com/proto/l18aumka9I3yuIv8W5JcGA/DolceDonuts---SET-H?type=design&t=HifTad7UBqVbb5vI-1&scaling=scale-down-width&page-id=0%3A1&node-id=1-16&starting-point-node-id=1%3A16&mode=design"
