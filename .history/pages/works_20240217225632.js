    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <main className={styles.works}>
          <div>
            <Box2 title='Dolce Donut' image='/images/dolcedonuts.png' target=”_blank”url="https://www.figma.com/proto/l18aumka9I3yuIv8W5JcGA/DolceDonuts---SET-H?type=design&t=HifTad7UBqVbb5vI-1&scaling=scale-down-width&page-id=0%3A1&node-id=1-16&starting-point-node-id=1%3A16&mode=design"/>
          </div>
          <div>
